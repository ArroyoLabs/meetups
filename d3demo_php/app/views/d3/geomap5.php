<?php echo Erdiko::getView(5, 'd3/map-nav.php'); ?>

<h3>Map with formatted earthquake data and additional styling</h3>
...
<script>
    ...
    function plotEarthquakes(scaleFactor) {
      var file = "d3/earthques-all_week.geo.json"; // local copy of http://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson
      d3.json(file,function(error, us) {
        ...
        g.append("g")
          ...
          .attr("d", path.pointRadius( function(d) { 
            // console.log(2*d.properties.mag/15);
