<?php echo Erdiko::getView(3, 'd3/map-nav.php'); ?>

<h3>Map with earthquake data</h3>
...
<script>
    ...
    function state_clicked(d) {
      ...
      if (d && state !== d) {
        ...
        var file = "d3/geo/cities_test.json"; // testing the format
        file = "d3/earthques-all_week.geo.json"; // local copy of http://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson
